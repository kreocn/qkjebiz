package com.qkj.outDetail.action;
import java.util.*;
...
public class OutDetailAction extends ActionSupport {
	...
	public String add() throws Exception {
		...
		try {
			...
			//outDetail.setLm_time(new Date()8);
			dao.add(outDetail);
			//修改出库主表
			...
			outStock.setTotal_price(newoutdStock.getTotal_price()+outDetail.getTotel());//总价
			...
			map.put("store_id", newoutdStock.getStore_id());
