 ...
 * @description
 * @date 2014-3-17 下午3:30:29
 */
public class DKN_SMS_Client {
	...
	private String sn = "DXX-BBX-010-19427";// 序列号
	private String password = "FdF6F2-7";// 密码
	private String pwd = "";

	/*
	 * 构造函数
	 */
	public DKN_SMS_Client(String sn, String password) throws UnsupportedEncodingException {
		this.sn = sn;
	 ...
	 * 构造函数
	 */
	public DKN_SMS_Client() throws UnsupportedEncodingException {
		this.pwd = this.getMD5(sn + password);
	}
	...
	/*
	 * 方法名称：mt 功 能：发送短信 ,传多个手机号就是群发，一个手机号就是单条提交 参 数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识) 返 回
	...
	/*
	 * 方法名称：gxmt 功 能：发送个性短信 ，即给不同的手机号发送不同的内容，手机号和内容用英文的逗号对应好 参数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识) 返 回
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		// 输入软件序列号和密码
		// String sn = "DXX-BBX-010-19427";// 换上您自己的序列号
		// String pwd = "cc@f4be@";// 换上您自己的密码
		String mobiles = "18611624580";
		String content = URLEncoder.encode("您的验证码为:984953[道可诺]", "utf8");

		System.out.println(content);

		DKN_SMS_Client client = new DKN_SMS_Client();
