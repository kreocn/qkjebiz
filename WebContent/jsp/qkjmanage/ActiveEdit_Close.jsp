...
<div class="main">
	...
	<div class="label_con">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
            ${active.close_sd_status }  ${active.close_smd_status }
				...
				<s:if test="50==active.close_sd_status && active.close_smd_status==50 && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVECLOSE_SDSTATUS10')">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
				...
				<s:if test="40==active.close_smd_status && active.close_sd_status==50 && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVECLOSE_SMDSTATUS30')">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
				<!-- 财务 -->
				<s:if test="(50==active.close_sd_status || 60==active.close_sd_status ) && active.close_smd_status==50 && 10!=active.close_fd_status && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVECLOSE_FDCSTATUS10')">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
				<!-- 财务 -->
				<s:if test="(50==active.close_sd_status || 60==active.close_sd_status )&& active.close_smd_status==50 && 10!=active.close_nd_status && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVECLOSE_NDCSTATUS10')">
