	...
	<div class="label_con">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
				...
				<s:if test="30==active.close_smd_status && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVE_SMDSTATUS50')">
        ...
        <s:if test="(50==active.close_sd_status || 60==active.close_sd_status ) && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVE_FDSTATUS10')">
        <div class="label_main">
        <div class="label_hang">
            <div class="label_ltit">财务审核:</div>
            <div class="label_rwbenx">
				<!-- 财务 -->
				<s:if test="10!=active.close_fd_status && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVE_FDSTATUS10')">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
				<!-- 财务 -->
				<s:if test="10!=active.close_nd_status && @org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_ACTIVE_NDCSTATUS10')">
