...
<div class="main" >
 	...
 	<div class="label_main">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwben label_rwb"><s:select id="status" name="salPromot.smd_status" cssClass="selectKick" headerKey="" headerValue="-活动状态-" list="#{0:'待审核',5:'已退回',20:'销管经理已审',30:'运营总监已审',40:'业务副总已审',50:'销管副总已审',60:'总经理已审'}" /></div>
        </div>
