...
<div class="main">
	...
	<div class="label_main">
	       <div class="label_hang">
		         ...
		         <div class="label_rwb"><s:textfield id="market.name" name="market.name" title="仓库名称" require="required" cssClass="label_hang_linput validate[required,maxSize[100]]" /></div>
		         </div>
	       	</div>
	 </div>
	 <div class="label_main">
	       <div class="label_hang">
		         ...
		         <div class="label_rwben2">
		         <div class="label_rwb"><s:textfield id="market.area" name="market.area" title="仓库名称" require="required" cssClass="label_hang_linput validate[required,maxSize[100]]" /></div>
		         </div>
	       	</div>
	 </div>
	 <div class="label_main">
	       <div class="label_hang">
		         ...
		         <div class="label_rwben2">
		         <div class="label_rwb"><s:textfield id="market.lead" name="market.lead" title="仓库地点" cssClass="label_hang_linput validate[maxSize[255]]" /></div>
		         </div>
	       	</div>
	 </div>
	 <div class="label_main">
        <div class="label_hang">
            ...
            <div class="label_rwbenx">
            	<s:textarea name="market.address" cssStyle="width:50%;" rows="3" title="联系地址" cssClass="label_hang_linput validate[maxSize[128]]" />
            </div>
        </div>
      </div>
      <div class="label_main">
	 ...
	 <div class="label_hang">
        ...
        <s:if test="null != market">
        	<div class="label_main">
			       <div class="label_hang">
				         <div class="label_ltit">横纵坐标:</div>
				         <div class="label_rwben2">
				         <div class="label_rwb">横坐标：${market.abs }&nbsp;纵坐标：${market.yaxis }</div>
				         </div>
			       	</div>
			 </div>
        	<div class="label_main">
		...
		<div class="label_hang">
            ...
            <span id="message"><s:property value="message" /></span>
				...
				<s:submit id="add" name="add" value="确定&填写坐标" action="market_add" cssClass="input-blue"/>
				</s:if>
				</s:if>
				<s:elseif test="null != market && 'mdy' == viewFlag">
				<s:if test="@org.iweb.sys.ContextHelper@checkPermit('QKJ_QKJMANAGE_MARKET_MDY')">
				<s:submit id="save" name="save" value="保存&修改坐标" action="market_save" cssClass="input-blue"/>
				</s:if>
