...
<s:iterator value="wares" status="sta">
	  <tr class="<s:if test="#sta.odd == true">oddStyle</s:if><s:else>evenStyle</s:else>">
		...
		<td align="center">
	    	[<a href="<s:url namespace="/sysebiz" action="ware_load"><s:param name="viewFlag">mdy</s:param><s:param name="ware.uuid" value="uuid"></s:param></s:url>">修改</a>]
	    	[<a href="<s:url namespace="/sysebiz" action="ware_del"><s:param name="ware.uuid" value="uuid"></s:param></s:url>" onclick="return isDel();">删除</a>]
	    </td>
	  </tr>
</s:iterator>
	  <tr>
