...
<div id="result">
	...
	<div class="ilistsearch noprintarea">
	<s:form id="search_form" name="search_form" action="memberCellar_list" namespace="/sysebiz"  onsubmit="return validator(this);" theme="simple">
		会员号:
		...
		<br />
		所在仓库:
		<span id="ware_select_area">
		<s:select list="wares" name="memberCellar.ware_id" 
			listKey="uuid" listValue="ware_name"
			headerKey="" headerValue="--请选择--" />
		</span>
		藏酒:<span id="goods_select_area">
		<s:select list="goodss" name="memberCellar.goods_id" 
			listKey="uuid" listValue="goods_name"
			headerKey="" headerValue="--请选择--" />
		</span>
		位置号(%):<s:textfield name="memberCellar.cellar_position" title="位置号" />
