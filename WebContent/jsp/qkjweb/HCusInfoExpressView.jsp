...
<s:form name="form1" action="hCusInfo_add" namespace="/webmanager" onsubmit="return validator(this);" method="post" theme="simple">
	...
	<table class="ilisttable" width="100%">
		<s:if test="null != hcusInfo">
		  <tr>
			...
			<td class='secRow'><s:property value="hcusInfo.lm_user" /></td>
			</tr>
			<tr>
			<td class='firstRow'>最后修改时间:</td>
			<td class='secRow'><s:date name="hcusInfo.lm_time" format="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
		...
		<tr>
			...
			<td class='secRow'><s:textfield name="hcusInfo.postno" title="邮编" dataLength="0,32" controlName="姓名" /></td>
		</tr>
		<tr>
		<td class='firstRow'>地址:</td>
		<td class='secRow'><s:textfield name="hcusInfo.address" title="地址" dataLength="0,255" controlName="地址" /></td>
		</tr>
		...
		<tr>
		    <td colspan="20" class="buttonarea">
				...
				<s:elseif test="null != hcusInfo && 'mdy' == viewFlag">
