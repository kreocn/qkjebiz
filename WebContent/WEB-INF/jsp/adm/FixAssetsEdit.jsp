...
<div class="tab_right">
	...
	<div class="dq_step">
		${path}
		<span class="opb lb op-area"><a href="<s:url namespace="/adm" action="fixassets_list"><s:param name="viewFlag">relist</s:param></s:url>">订单列表</a></span>
	</div>
	<s:form id="formEdit" name="form1" cssClass="validForm" action="fixassets_add" namespace="/adm" onsubmit="return validator(this);" method="post" theme="simple">
 			...
 			<div class="label_main">
 				<s:if test="null != fixassets">
 					<div class="label_hang">
				       ...
				       <div class="label_rwben">${fixassets.uuid}<s:hidden name="fixassets.uuid"  title="系统编号"/></div>
					</div>
					<div class="label_hang">
 				...
 				<div class="label_hang">
			       ...
			       <div class="label_rwben2">
						...
						<s:textfield title="资产名称" id="userdept_nameid" name="fixassets.type_title" readonly="true" />
						<s:hidden title="资产编号" id="userdept_codeid" name="fixassets.typea" readonly="true" />
						</span>
						<span class="lb nw">
						<img class="detail vatop" src='<s:url value="/images/open2.gif" />' onclick="selectWarevar('userdept_codeid','userdept_nameid',1);" />
						</span>
			       </div>
				</div>
				...
				<div class="label_hang">
			       ...
			       <div class="label_rwben"><s:textfield name="fixassets.title" title="资产名称" cssClass="validate[required,maxSize[128]]"/></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">参考型号:</div>
			       <div class="label_rwben"><s:textfield id="assets_model" name="fixassets.model" title="参考型号" cssClass="validate[maxSize[96]]"/></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">参考规格:</div>
			       <div class="label_rwben"><s:textfield id="assets_spec" name="fixassets.spec" title="参考规格" cssClass="validate[maxSize[96]]"/></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">参考价格:</div>
			       <div class="label_rwben"><s:textfield id="assets_price" name="fixassets.price" title="参考价格" cssStyle="width:80%;" cssClass="validate[custom[number],maxSize[10]]"/><span class="pricecss">&nbsp;元</span></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">数量:</div>
			       <div class="label_rwben"><s:textfield id="assets_num" name="fixassets.num" title="数量" cssClass="validate[required,custom[number],maxSize[10]]"/></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">总价:</div>
			       <div class="label_rwben"><s:textfield id="assets_price_scope" name="fixassets.price_scope" title="总价" cssStyle="width:80%;" cssClass="validate[custom[number],maxSize[10]]"/><span class="pricecss">&nbsp;元</span></div>
				</div>
				<div class="label_hang">
				...
				<div class="label_hang">
				       ...
				       <div class="label_rwbenx"><s:textfield id="fixassets.p_mobile" title="电话" name="fixassets.p_mobile" /></div>
				</div>
				<div class="label_hang">
				       <div class="label_ltit">保修期限:</div>
				       <div class="label_rwbenx"><s:textfield id="fixassets.warrantytime" title="保修期限" name="fixassets.warrantytime" /></div>
				</div>
				
				<div class="label_hang">
			       <div class="label_ltit">采购时间:</div>
			       <div class="label_rwben"><input class="datepicker validate[required,custom[date]]" type="text" name="fixassets.p_time" title="采购时间" value="${it:formatDate(fixassets.p_time,'yyyy-MM-dd')}" /></div>
				</div>
				<div class="label_hang">
			       <div class="label_ltit">报废时限(月):</div>
			       <div class="label_rwben"><s:textfield name="fixassets.p_scrap" title="报废时限(月)" cssClass="validate[custom[integer],maxSize[10]]"/></div>
				</div>
				<div class="label_main">
					<div class="label_hang">
			       		...
			       		<div class="label_rwbenx">
							...
							<input type="button" value="返回" onclick="linkurl('<s:url action="assetstype_relist" namespace="/adm" />');" />
 	...
 	<div  id="mdyAssetItemsOwn" style="background-color: #EEEEEE; border: 1 solid #000000;  
 width: 130; height: 25;overflow:auto" onmouseover=this.style.height="130"; onmouseout=haiwa.style.height='25';>  
