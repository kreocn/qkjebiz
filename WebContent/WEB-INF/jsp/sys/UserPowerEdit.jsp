	...
	<s:if test="'mdy'==viewFlag">
		 <div class="label_main">
			...
			<tr>
				...
				<th>子部门管理权限</th>
				<th>更新时间</th>
				<th><a href="<s:url namespace="/sysvip" action="memberAddress_load"><s:param name="viewFlag">add</s:param><s:param name="memberAddress.member_id" value="member.uuid" /></s:url>" >添加部门及权限</a></th>
			</tr>
