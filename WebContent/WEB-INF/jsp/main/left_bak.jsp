...
for (var i = 0; i < menuArray.length; i++) {
	...
	if(menuArray[i].p_id=='0') {
		_m_str+='<li id="M'+menuArray[i]['uuid']+'" data-role="collapsible" data-enhanced="true" data-collapsed-icon="carat-d" data-expanded-icon="carat-u" data-iconpos="right" data-inset="false" class="prvg-module-'+menuArray[i]['module']+' ui-collapsible ui-collapsible-themed-content ui-collapsible-collapsed"><h3 class="ui-collapsible-heading ui-collapsible-heading-collapsed"><a href="javascript:;" class="ui-collapsible-heading-toggle ui-btn ui-btn-icon-right ui-btn-inherit ui-icon-carat-d">'+menuArray[i]['name']+'</a></h3>';
