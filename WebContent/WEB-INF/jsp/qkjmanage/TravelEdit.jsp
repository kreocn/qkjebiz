...
<style type="text/css">
.lb_jiup th,.lb_jiup td {
	border: 1px solid #ccc; text-align: center; line-height: 22px; font-size: 12px;
}
</style>
</head>
<body>
				...
				<div class="label_con">
					<div class="label_main">
						<s:if test="'mdy' == viewFlag">
							<div class="label_hang">
								...
								<div class="label_rwben">${travel.uuid}<s:hidden name="travel.uuid" />
							...
							<div class="label_hang">
								...
								<div class="label_rwbenx">
									...
									<s:if test="travel.check_status==5">
										<span class="message_error">已退回</span>
										<span class="nowrap">(${travel.check_user_name} ${it:formatDate(travel.check_time,'yyyy-MM-dd HH:mm:ss')})</span>
									</s:if>
									<s:if test="travel.check_status==10">
										<span class="message_warning">待审核</span>
									</s:if>
									...
									<s:if test="travel.check_status==30">
										<span class="message_pass">总监已审</span>
										<span class="nowrap">(${travel.check_user_name} ${it:formatDate(travel.check_time,'yyyy-MM-dd')})</span>
									</s:if>
									<s:if test="travel.check_status==40">
							...
							<div class="label_hang">
								...
								<div class="label_rwbenx">
									...
									<s:if test="travel.acheck_status==5">
										<span class="message_error">已退回</span>
										<span class="nowrap">(${travel.acheck_user_name} ${it:formatDate(travel.acheck_time,'yyyy-MM-dd HH:mm:ss')})</span>
									</s:if>
									<s:if test="travel.acheck_status==10">
										<span class="message_warning">待审核</span>
									</s:if>
									<s:if test="travel.acheck_status==20">
										<span class="message_pass">行政经理已审</span>
										<span class="nowrap">(${travel.acheck_user_name} ${it:formatDate(travel.acheck_time,'yyyy-MM-dd HH:mm:ss')})</span>
									</s:if>
									<s:if test="travel.acheck_status==30">
										<span class="message_pass">行政副总已审</span>
										<span class="nowrap">(${travel.acheck_user_name} ${it:formatDate(travel.acheck_time,'yyyy-MM-dd HH:mm:ss')})</span>
									</s:if>
									<s:if test="travel.acheck_status==40">
						...
						<div class="label_hang">
							...
							<div class="label_rwbenx">${travel.apply_dept_name}&nbsp;${travel.apply_user_name}<s:hidden name="travel.apply_dept" />
								<s:hidden name="travel.apply_user" />
							</div>
						</div>
						<div class="label_hang">
						...
						<div class="label_hang">
							...
							<div class="label_rwben2">
								<span class="label_rwb nw"> <input class="datepicker iI iI-f validate[custom[date]]" type="text" name="travel.travel_date" title="从" value="${it:formatDate(travel.travel_date,'yyyy-MM-dd')}" />
								</span> <span class="label_rwb nw"> <input class="datepicker iI iI-t validate[custom[date]]" type="text" name="travel.travel_date_end" title="到" value="${it:formatDate(travel.travel_date_end,'yyyy-MM-dd')}" />
								</span>
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwben">
								<s:textfield name="travel.travel_num" title="客户人数" cssStyle="width:80%;" cssClass="validate[custom[integer],maxSize[10]]" />
								人
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwben">
								<s:textfield name="travel.accompany_num" title="陪同人数" cssStyle="width:80%;" cssClass="validate[custom[integer],maxSize[10]]" />
								人
							</div>
						</div>
					</div>
					...
					<div class="label_main">
						<div class="label_hang">
							...
							<div class="label_rwb">
								<s:textfield id="order_user_id" name="travel.member_id" title="会员号" cssClass="validate[required]" />
							</div>
						</div>
						<div class="label_hang">
							<div class="label_ltit">手机:</div>
							<div class="label_rwb">
								<s:textfield id="order_user_mobile" name="travel.member_phone" title="手机" controlName="手机" />
							</div>
						</div>
						<div class="label_hang">
							<div class="label_ltit">收货人姓名:</div>
							<div class="label_rwb">
								<s:textfield id="order_user_name" name="travel.members_names" title="姓名" controlName="姓名" cssClass="validate[required,maxSize[85]]" />
							</div>
						</div>
					</div>
					<div class="label_main">
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								<s:textarea id="address" name="travel.member_address" title="配送地点" rows="4" cssClass="label_hang_linput validate[required,maxSize[128]]"></s:textarea>
								...
								<table id="table1" width="100%" class="lb_jpin">
									...
									<s:iterator value="travelCustomers" status="sta">
										<tr>
											<td>${uuid}</td>
											<td>${cus_name}</td>
											<td><s:if test="cus_sex==0">男</s:if> <s:elseif test="cus_sex==1">女</s:elseif></td>
											<td>${cus_company}</td>
											<td><s:if test="cus_type==1">政府</s:if> <s:elseif test="cus_type==2">企业</s:elseif> <s:elseif test="cus_type==3">经销商</s:elseif> <s:elseif test="cus_type==4">潜在客户</s:elseif> <s:elseif test="cus_type==5">终端零售</s:elseif> <s:elseif test="cus_type==6">专卖店消费者</s:elseif> <s:elseif test="cus_type==7">其他</s:elseif>
											</td>
											<td>${cus_phone}</td>
											<td>${cus_idcard}</td>
											<td align="center"><c:if test="${(travel.check_status<=5 ||  travel.acheck_status<=5) && it:checkPermit('QKJ_QKJMANAGE_TRAVELCUSTOMER_DEL',null)==true}">
					...
					<fieldset class="clear">
						...
						<div class="label_hang">
							...
							<div class="label_rwben2">
								￥
								<s:textfield name="travel.lunch_price" cssStyle="width:80px;" title="午餐标准/桌" cssClass="validate[custom[number],maxSize[10]]" />
								元/桌 共
								<s:textfield name="travel.lunch_num" cssStyle="width:40px;" title="午餐次数" cssClass="validate[custom[integer],maxSize[10]]" />
								次 每次
								<s:textfield name="travel.lunch_desk" cssStyle="width:40px;" title="午餐桌数" cssClass="validate[custom[integer],maxSize[10]]" />
								桌
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								...
								<s:textfield name="travel.cigarette_num" title="准备香烟包数" cssStyle="width:40px;" cssClass="validate[custom[integer],maxSize[10]]" />
								包
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								￥
								<s:textfield name="travel.dinner_price" cssStyle="width:80px;" title="晚餐标准/桌" cssClass="validate[custom[number],maxSize[10]]" />
								元/桌 共
								<s:textfield name="travel.dinner_num" cssStyle="width:40px;" title="晚餐次数" cssClass="validate[custom[integer],maxSize[10]]" />
								次 每次
								<s:textfield name="travel.dinner_desk" cssStyle="width:40px;" title="晚餐桌数" cssClass="validate[custom[integer],maxSize[10]]" />
								桌
							</div>
						</div>
						<div class="label_hang">
						...
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								<s:textfield name="travel.hotel_house" cssStyle="width:40px;" title="别墅规格(几人一套)" cssClass="validate[custom[integer],maxSize[10]]" />
								人间
								<s:textfield name="travel.hotel_house_num" cssStyle="width:40px;" title="别墅套数" cssClass="validate[custom[integer],maxSize[10]]" />
								套
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								<input style="width: 90px;" class="datepicker validate[custom[date]]" type="text" name="travel.hotel_start" title="开始住宿时间" value="${it:formatDate(travel.hotel_start,'yyyy-MM-dd')}" /> &nbsp;-&nbsp; <input style="width: 90px;" class="datepicker validate[custom[date]]" type="text" name="travel.hotel_end"
									title="结束住宿时间" value="${it:formatDate(travel.hotel_end,'yyyy-MM-dd')}" /> 共
								<s:textfield name="travel.hotel_total" cssStyle="width:40px;" title="总共住宿天数" cssClass="validate[custom[integer],maxSize[10]]" />
								天
							</div>
						</div>
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								<s:textfield name="travel.hotel_twinroom" cssStyle="width:40px;" title="标间间数" cssClass="validate[custom[integer],maxSize[10]]" />
								间
							</div>
						</div>
						<div class="label_hang">
										...
										<table class="lb_jiup" width="300" id="table1">
											...
											<s:iterator value="travelProducts" status="sta">
												<tr>
													<td>${product_name}</td>
													<td>${num}</td>
													<td><c:if test="${(travel.check_status<=5 ||  travel.acheck_status<=5) && it:checkPermit('QKJ_QKJMANAGE_TRAVELPRODUCT_DEL',null)==true}">
					...
					<div class="label_hang clear">
						...
						<div class="label_rwbenx">
							&nbsp;<span class="message_prompt">请尽量不要超过8行</span>
						</div>
					</div>
					<div class="label_main">
						<div class="note_area">
					...
					<fieldset class="clear">
						...
						<div class="label_hang">
							...
							<div class="label_rwben">
								<s:textfield name="travel.gift" title="礼品品相" cssClass="validate[maxSize[108]]" />
							</div>
						</div>
						<div class="label_hang">
							<div class="label_ltit">礼品份数:</div>
							<div class="label_rwben">
								<s:textfield name="travel.gift_num" title="礼品份数" cssClass="validate[custom[integer],maxSize[10]]" />
							</div>
						</div>
					</fieldset>
						...
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								...
								<s:elseif test="'mdy' == viewFlag">
									...
									<s:else>
										<s:if test="travel.apply_dept.substring(0,5)=='31411'">
										<c:if test="${it:checkPermit('QKJ_QKJMANAGE_TRAVEL_CHECK26',null)==true && travel.check_status==10}">
											<s:submit cssClass="input-green"  value="区域经理审核通过" action="travel_mdyCheckStatus26" onclick="return isOp('确定要执行此操作?');" />
										</c:if>
										<c:if test="${it:checkPermit('QKJ_QKJMANAGE_TRAVEL_CHECK10',null)==true && travel.check_status==26}">
										...
										<s:if test="travel.apply_dept.substring(0,3)=='220'">
										<c:if test="${it:checkPermit('QKJ_QKJMANAGE_TRAVEL_ACHECK30',null)==true && travel.check_status==10 &&  travel.acheck_status!=40}">
			...
			<s:form name="form1" cssClass="validForm" action="travelCustomer_add" namespace="/qkjmanage" onsubmit="return validator(this);" method="post" theme="simple">
				...
				<table width="100%" class="ilisttable">
					...
					<tr>
						...
						<td><s:textfield id="travelCustomer_cus_company" name="travelCustomer.cus_company" title="单位名称" cssClass="validate[maxSize[255]]" /> <br />
						<select id="cus_select"><option>--请选择--</option></select></td>
					</tr>
					<tr>
						<td align="right">客户类别:</td>
						<td><s:select name="travelCustomer.cus_type" title="客户类别" list="#{1:'政府',2:'企业',3:'经销商',4:'潜在客户',5:'终端零售',6:'专卖店消费者',7:'其他'}" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td class="buttonarea"><c:if test="${it:checkPermit('QKJ_QKJMANAGE_TRAVELCUSTOMER_ADD',null)==true && (travel.check_status<=5 ||  travel.acheck_status<=5)}">
		...
		<div id="AddProductForm" title="添加酒品">
			<s:form name="form1" cssClass="validForm" action="travelProduct_add" namespace="/qkjmanage" onsubmit="return validator(this);" method="post" theme="simple">
				<div class="ifromoperate">
					<input type="hidden" name="travelProduct.travel_id" value="${travel.uuid }" />
				</div>
				<table class="ilisttable" width="100%">
					<tr>
						<td align="right" width="25%">产品:</td>
						<td><s:select name="travelProduct.product_id" list="products" listKey="uuid" listValue="title" cssClass="validate[required]" headerKey="" headerValue="--请选择--" /></td>
					</tr>
					<tr>
						<td align="right" valign="top" style="line-height: 26px;">数量:</td>
						<td><s:textfield name="travelProduct.num" title="数量" cssClass="validate[required,custom[integer],maxSize[10]]" /> <br />
						<span class="message_prompt">散酒(公斤) | 瓶装酒(瓶)</span></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td class="buttonarea"><c:if test="${it:checkPermit('QKJ_QKJMANAGE_TRAVELPRODUCT_ADD',null)==true}">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			//<s:if test="'mdy' == viewFlag">
			$("#AddCustomerForm").dialog({ autoOpen : false,
			height : 330,
			width : 420,
			modal : true });
	...
	var c_mid = '<s:property value="travel.member_id" />';
	$(function(){
	...
	function createAddreeeSelect(p_data){
		...
		for (var i = 0; i < p_data.length; i++) {
			...
			if (p_data[i].defaultaddress == 1) {
				$(":input[name='travel.member_address']").val(sh);
		...
		selectid.unbind().bind("change", function(){
			$(":input[name='travel.member_address']").val(c_data[$(this).getSelectedValue()]);
		});
	}
</script>
</body>
