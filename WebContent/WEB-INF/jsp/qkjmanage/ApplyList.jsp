    ...
    <div class="label_hang">
      ...
      <div class="label_hang">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwben2">
            	<span class="label_rwb">
            	<s:select name="apply.status_sp" title="状态" headerKey="" headerValue="-申请状态-" list="#{-1:'已作废',0:'新申请',5:'审核退回',10:'待审核',20:'业务部经理已审',25:'销管经理已审',30:'总监已审',35:'总监待审',40:'副总已审',50:'总经理已审',70:'营销副总待审'}" />
				</span>
				<span class="label_rwb">
		...
		<table>
			...
			<tr id="showtr${uuid}">
				...
				<td class="td1 nw" title="${check_user_name}-${it:formatDate(check_time,'yyyy-MM-dd HH:mm:ss')}-${check_note}">
					...
					<s:if test="9==status"><span class="message_pass">办事处/负责人已审</span></s:if>
			      ...
			      <s:if test="26==status"><span class="message_pass">区域经理已审</span></s:if>
					...
					<s:if test="80==status"><span class="message_pass">营销中心副总已审</span></s:if>
			</s:else>
				</td>
