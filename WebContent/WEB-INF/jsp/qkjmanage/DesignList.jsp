	...
	<s:hidden name="per" value="null"></s:hidden>
 	...
 	<div class="label_main">
        ...
        <div class="label_hang">
            ...
            <div class="label_rwben"><s:textfield  name="active.design_name"/></div>
        </div>
        
        <div class="label_hang">
            <div class="label_ltit">门头类型:</div>
            <div class="label_rwben"><s:textfield  name="active.design_type"/></div>
        </div>
 	...
 	<div class="tab_warp">
		...
		<th class="td0">查看</th>
	  	...
	  	<tr id="showtr${uuid}">
			...
			<td class="td2 nw">(申)${design_total}
			<s:if test="status > 2">
