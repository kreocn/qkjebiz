...
<body>
	...
	<div class="tab_right">
		<div class="tab_warp main">
			<div class="dq_step">
				<span id="hs" class="pt">活动结案单</span> <span id="ks" class="pt kss">活动客户结案通知单</span> <span class="opb lb op-area noprint"> <a class="input-gray" href="<s:url namespace="/qkjmanage" action="active_list"><s:param name="viewFlag">relist</s:param></s:url>">返回列表</a>
				</span> <span class="opb lb op-area noprint"><a href="<s:url namespace="/qkjmanage" action="active_closeLoad"><s:param name="active.uuid" value="%{active.uuid}"></s:param></s:url>">返回修改页面</a></span> <span class="opb lb op-area noprint"><input type="button" onclick="ypri();window.print();" value="打印本页" /> &nbsp;</span> <span
					class="opb lb op-area noprint"><input type="button" onclick="indprint();" value="打印海拔系列" />&nbsp;</span> <span class="opb lb op-area noprint"><input type="button" onclick="otherprint();" value="打印非海拔系列" />&nbsp;</span> <span class="opb lb op-area noprint"><input type="button" onclick="tastingprint();"
					value="打印品鉴酒" />&nbsp;</span> <span class="opb lb op-area noprint"><input type="button" onclick="nopri();window.print();" value="打印结案通知单" />&nbsp;</span>
									...
									<div class="zhuangtai bgcw">
										<s:if test="puser_sign!=null ">
											<s:if test="caiActive==null||guanActive==null ||fuActive==null">
												...
												<s:elseif test="guanActive!=null">
													<s:if test="%{guanActive.puser_sign!=puser_sign}">
														<span class="user_sign"><img src="${puser_sign}" /></span>
														<span class="vab">${it:formatDate(biz_time,'yyyy-MM-dd HH:mm:ss')}</span>
													</s:if>
												</s:elseif>
												<s:elseif test="fuActive!=null">
													<s:if test="%{fuActive.puser_sign!=puser_sign}">
														<span class="user_sign"><img src="${puser_sign}" /></span>
														<span class="vab">${it:formatDate(biz_time,'yyyy-MM-dd HH:mm:ss')}</span>
													</s:if>
												</s:elseif>
						...
						<div class="lb_xxsm">
							...
							<div class="lb_lgsfy">
								...
								<div class="lb_yjcon">
									...
									<p id="otherprice" class="lb_jwei kss">￥${active.close_it_price-indprice-tastingPrice}</p>
							...
							<p id="indprice2" class="lb_yjbot kss">方案预计费用总计: ${indprice+Posms} + ${active.close_mt_price} = ￥${indprice+Posms+active.mt_price}</p>
							<p id="otherprice2" class="lb_yjbot kss">方案预计费用总计: ${active.close_it_price-indprice-tastingPrice} + ${active.mt_price} = ￥${active.close_it_price-indprice-tastingPrice+active.mt_price}</p>
							<p id="tastingprice2" class="lb_yjbot kss">方案预计费用总计: ${tastingPrice+Posms} + ${active.close_mt_price} = ￥${tastingPrice+Posms+active.close_mt_price}</p>
						</div>
					</div>
					...
					<div class="label_main noprint">
						<div class="label_hang">
							...
							<div class="label_rwbenx">
								...
								<input type="button" value="返回" class="input-gray" onclick="linkurl('<s:url action="active_relist" namespace="/qkjmanage" />');" /> <input type="button" onclick="window.print();" value="打印本页" /> <input type="button" onclick="nopri();window.print();" value="打印结案通知单" />&nbsp; <input type="button"
									onclick="nopri();window.print();" value="打印结案通知单" />&nbsp; <input type="button" value="返回修改页面" onclick="linkurl('<s:url action="active_closeLoad" namespace="/qkjmanage"><s:param name="active.uuid" value="%{active.uuid}"></s:param></s:url>');" />
	...
	<script type="text/javascript">
		...
		function yindpri(){
			...
			$("#tastingprice2").addClass("noprint"); //添加样式
		}
