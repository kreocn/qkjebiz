...
<div class="tab_right">
 	...
 	<s:hidden name="closeOrder.uuid" value="%{closeOrder.uuid }"></s:hidden>
 	<div class="label_con">
		...
		<table>
			...
			<tr id="showtr${uuid}">
				...
				<td class="td4 op-area">				
			    	<a class="input-red" href="<s:url namespace="/qkjmanage" action="closeOrder_savet"><s:param name="closeOrder.uuid" value="closeOrder.uuid"></s:param><s:param name="closeOrder.salPro_id" value="uuid"></s:param></s:url>" >选择</a>
				</td>
