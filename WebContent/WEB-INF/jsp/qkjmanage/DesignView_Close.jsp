...
<div class="noprint input-a" style="text-align: center;">
 ...
 <div class="danz_warp printmain">
	...
	<div class="danz_top">
        ...
        <p class="danz_rdate">制表日期：${it:formatDate(pro.biz_time,'yyyy年MM月dd日')}</p>
    ...
    <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" class="danz_table">
        <tr>
        	...
        	<td width="13%"colspan="2">${active.close_design_num}</td>
        </tr>
        
        <tr>
        	<td width="14%" style="font-weight: bold;">类型</td>
        	<td width="32%">${active.design_type}</td>
        	<td width="14%" style="font-weight: bold;">单价/m²（元）</td>
        	<td width="13%">${active.close_design_price}</td>
        	<td width="14%" style="font-weight: bold;">合计（元）</td>
        	<td width="13%">${active.close_design_total}</td>
            
        </tr>
        <tr>
        	<td width="14%" style="font-weight: bold;">申请人</td>
            <td width="32%">${active.apply_user_name}</td>
        ...
        <tr>
            <td style="font-weight: bold;" rowspan="4">门头印刷品说明</td>
            <td>尺寸</td>
            <td colspan="4"><u> ${active.close_store_size} </u> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4">${active.close_assumed }</td>
        </tr>
        ...
        <tr>
            <td style="font-weight: bold;">财务</td>
            <td colspan="5" height="78" valign="top" style="padding:0; position:relative;">
            	<div class="danz_yjian"></div>
            	<div class="danz_qzi" style="width: 180px;">签字:
            	<s:if test="daquActive!=null && daquActive.puser_sign!=null">
								<span class="user_sign"><img src="${daquActive.puser_sign}" /></span>
							</s:if>
            	</div>
                <div class="danz_date" style="width: 110px;">日期：${it:formatDate(daquActive.biz_time,'yyyy-MM-dd')}</div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="5" height="78" valign="top" style="padding:0; position:relative;">
            	<div class="danz_yjian"></div>
            	<div class="danz_qzi" style="width: 180px;">签字:
            	<s:if test="zongjianActive!=null && zongjianActive.puser_sign!=null">
        ...
        <tr>
            ...
            <td colspan="5" height="78" valign="top" style="padding:0; position:relative;">
            	<div class="danz_yjian"></div>
            	<div class="danz_qzi" style="width: 180px;">签字:
            	<s:if test="fuActive!=null && fuActive.puser_sign!=null">
