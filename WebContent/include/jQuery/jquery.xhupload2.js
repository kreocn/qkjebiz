...
(function($){
	...
	$.fn.xhcreate = function(o, c){
		var oid = o.attr("id");
		o.after('<span class="opb lb op-area"><input type="button" id="' + oid + '_filebutton" name="filebutton" value="选择导入文件"/></span>');
	...
	$.fn.xhUploadFile = function(file_id){
		...
		$.ajax({ url : "/upload/memberStock_lead",
		type : "POST",
		data : formData,
		processData : false,
